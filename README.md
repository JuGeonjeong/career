...
<details>
                                <summary>0906~0907 HTTP 강의</summary> 
...
---
   ...
   * Stateless : 서버와의 상태 보존 안됨 -> / 서버가 바뀌어도 됨. 무한한 서버 증설 가능.   
   ...
   #### GET : 리소스 조회 / URL의 쿼리파라미터,쿼리스프링을 통햏 전달   
      
   #### POST : 요청 데이터 처리 / 메세지 바디를 통해 서버로 요청 데이터 전달 / 주로 신규 리소스 드록, 프로세스 처리에 사용   
   !! 단순히 생성, 변경하는 것을 넘어 프로세스를 처리해야 하는 
